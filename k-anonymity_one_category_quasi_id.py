...
@author: LENOVO
"""
# this code contains one numerical and one categorical column as a quasi identifier
import pandas as pd
...
print(dfn)
dfn.to_csv("anonymised_k_1_catg_quasi.csv")
...
dfl.to_csv("anonymised_l_1_catg_quasi.csv")
...
print('Discernibility Metric for Mondrian after l diversity: ', discernibility)
...
dft.to_csv("anonymised_t_1_catg_quasi.csv")
column_x, column_y = feature_columns[:2]
