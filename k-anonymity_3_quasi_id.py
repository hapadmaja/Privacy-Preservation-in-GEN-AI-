# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 18:43:41 2024
...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 12 09:18:43 2024

@author: 2021503034
"""
# this code contains three quasi identifiers - age, education num and hours per week 
...
dfn.to_csv("anonymised_k_3_quasi.csv")
print('sorted')
...
print('Discernibility Metric for Mondrian for k : ', discernibility)
...
dfl.to_csv("anonymised_l_3_quasi.csv")
...
dft.to_csv("anonymised_t_3_quasi.csv")
column_x, column_y = feature_columns[:2]
