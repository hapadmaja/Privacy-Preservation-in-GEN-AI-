# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 21:11:38 2024
...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 20:16:47 2024

@author: LENOVO
"""
# this code contains two categorical columns as a quasi identifier
import pandas as pd
...
feature_columns = ['occupation', 'native-country']
...
print(dfn)
dfn.to_csv("anonymised_k_2_catg_quasi.csv")
...
print('Discernibility Metric for Mondrian for k-anonymity: ', discernibility)
...
dfl.to_csv("anonymised_l_2_catg_quasi.csv")
...
# Count distinct combinations of QI attributes
orig_n = df[qi_columns].drop_duplicates().shape[0]  
mondrian_n = dfl[qi_columns].drop_duplicates().shape[0]
print("orig_n : ",orig_n)
print("mondrian_n",mondrian_n)
# Calculate Discernibility Metric
discernibility = orig_n - mondrian_n

print('Discernibility Metric for Mondrian for l: ', discernibility)
...
dft.to_csv("anonymised_t_2_catg_quasi.csv")
column_x, column_y = feature_columns[:2]
...
print('Discernibility Metric for Mondrian for t: ', discernibility)